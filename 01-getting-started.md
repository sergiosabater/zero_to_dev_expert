...
![Journey](https://img.shields.io/badge/The-Journey-blueviolet?style=for-the-badge)
![Status](https://img.shields.io/badge/Status-Day_One-success?style=for-the-badge)
...
```mermaid
graph LR
    A[Coding] --> B[Problem Solving]
    A --> C[Resilience]
    A --> D[Creativity]
    A --> E[Learning]
    
    B --> F[Breaking down problems]
    C --> G[Overcoming errors]
    D --> H[Building solutions]
    E --> I[Continuous growth]
...
<img src="https://media.giphy.com/media/WRQBXLCnRPxX1/giphy.gif" width="400">
...
```mermaid
graph TB
    A[1. Unconscious Incompetence] --> B[2. Conscious Incompetence]
    B --> C[3. Conscious Competence]
    C --> D[4. Unconscious Competence]
    
    A --> A1["I don't know what I don't know"]
    B --> B1["I know what I don't know"]
    C --> C1["I can do it with effort"]
    D --> D1["It's second nature"]
...
<img src="https://media.giphy.com/media/wJO6Vl2s156/giphy.gif" width="400">
...
```mermaid
graph LR
    A[Day 1<br/>Mindset] --> B[Week 1<br/>Basics]
    B --> C[Week 4<br/>Projects]
    C --> D[Week 8<br/>Specialization]
    D --> E[Week 12<br/>Portfolio]
    E --> F[Week 16<br/>Job Ready]
...
[![Continue](https://img.shields.io/badge/➡️_Continue_to_Chapter_02-Environment_Setup-success?style=for-the-badge)](./02-environment-setup.md)
